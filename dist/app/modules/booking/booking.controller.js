 ...
 */
exports.bookSeats = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const booking = yield BookingService.bookSeats(eventId, seatIds, userId);
    res.send((0, response_helper_1.createResponse)(booking, "booking sucess .."));
}));
