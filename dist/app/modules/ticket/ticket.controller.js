 ...
 */
exports.validateTicket = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { bookingId, eventId } = req.body;
    if (!bookingId || !eventId)
        return;
    const data = yield TicketService.validateTicket(bookingId, eventId);
    res.send((0, response_helper_1.createResponse)(data, "verification sucessfull .."));
}));
